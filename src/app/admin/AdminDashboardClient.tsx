  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
        ...
        <div className="mb-12 flex items-center justify-between bg-linear-to-br from-blue-500/10 via-blue-500/5 to-background rounded-3xl p-8 border border-blue-500/20">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-500/10 rounded-full border border-blue-500/20">
              ...
              <span className="text-sm font-medium text-blue-500">Admin Dashboard</span>
            </div>
            <div>
              ...
              <p className="text-muted-foreground">
                Manage doctors, inspect appointments, and monitor your health performance.
              </p>
            </div>
          </div>
          ...
          <div className="hidden lg:block">
            <div className="w-32 h-32 bg-linear-to-br from-blue-500/20 to-blue-500/10 rounded-full flex items-center justify-center">
              <SettingsIcon className="w-16 h-16 text-blue-500" />
            </div>
          </div>
        </div>
