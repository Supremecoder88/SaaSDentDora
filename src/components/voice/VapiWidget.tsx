    ...
    <div className="max-w-5xl mx-auto px-4 flex flex-col overflow-hidden pb-20">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold font-mono">
          ...
          <span className="text-blue-500 uppercase">AI Dental Assistant</span>
        </h1>
          ...
          <div className="aspect-video flex flex-col items-center justify-center p-6 relative">
            ...
            >
              <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 flex justify-center items-center h-20">
                {[...Array(5)].map((_, i) => (
                  <div
                    key={i}
                    className={`mx-1 h-16 w-1 bg-blue-500 rounded-full ${
            ...
            <div className="relative size-32 mb-4">
              ...
              <div className="relative w-full h-full rounded-full bg-card flex items-center justify-center border border-border overflow-hidden">
                <div className="absolute inset-0 bg-linear-to-b from-blue-500/10 to-blue-500/5"></div>
                <Image
                  src="/logo3.png"
