...
function Hero() {
  return (
    <section className="relative h-screen flex items-center overflow-hidden pt-20">
      {/* GRID BG (MODIFIED: Replaced to-primary/5 with to-blue-400/5) */}
      ...
      {/*orbs (Already set to blue-400)*/}
      <div className="absolute top-20 left-1/4 w-72 h-72 bg-linear-to-r from-blue-400/20 to-blue-400/10 rounded-full blur-3xl" />
      <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-linear-to-r from-blue-400/15 to-blue-400/5 rounded-full blur-3xl" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                {/* BADGE  */}
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-blue-400/10 to-blue-400/5 rounded-full border border-blue-400/20 backdrop-blur-sm">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Trusted by{" "}
                      <span className="font-semibold text-foreground">over 1000 patients</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative lg:pl-8">
              ...
              {/* GRADIENT ORBS  */}
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-linear-to-br from-blue-400/20 to-blue-400/10 rounded-2xl rotate-45 blur-xl"></div>
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-linear-to-br from-blue-400/15 to-blue-400/5 rounded-full blur-2xl"></div>

              {/* BLURRED BACKDROP MATCHING HERO */}
              <div className="absolute inset-0 -z-10 rounded-3xl 
                bg-linear-to-br from-background via-muted/20 to-background
                blur-2xl scale-105 opacity-90"
              />

              {/* OPTIONAL DARK FADE EDGE */}
              <div className="absolute inset-0 -z-10 rounded-3xl 
                bg-linear-to-l from-background via-transparent to-transparent"
              />
